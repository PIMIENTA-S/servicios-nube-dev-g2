...
| ----------------------------------- | --------------------------------- | ------------------------ |
| **EC2 (Auto Scaling Group)**        | 1 × t3.micro (on-demand)          | **$8.47**                |
| **EBS (Volumen raíz EC2)**          | 20 GB GP3                         | **$1.92**                |
| **NAT Gateway**                     | 1 NAT + ~30 GB de tráfico         | **$35 – $40**            |
| **Application Load Balancer (ALB)** | 1 ALB + 1 LCU                     | **$18 – $22**            |
| **RDS PostgreSQL**                  | db.t4g.micro + 20GB + backups     | **$24 – $27**            |
| **S3 Bucket**                       | ~1GB + GET/PUT bajos              | **$0.50 – $1.00**        |
| **AWS Lambda (3 funciones)**        | Baja ejecución (<100k ms)         | **~$0.20**               |
| **API Gateway (REST)**              | ~100k requests                    | **$3.50**                |
